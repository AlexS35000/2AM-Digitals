...
<!---------------------------------------------------------------- SECTION 1 ---------------------------------------------------------------->
<form id="s1" method="post" action="admin-page3" enctype="multipart/form-data" class="section0-1">
...
<!---------------------------------------------------------------- SECTION 2 ---------------------------------------------------------------->
<form id="s2" method="post" action="admin-page3" enctype="multipart/form-data" class="section0-1">
...
<!---------------------------------------------------------------- SECTION 3 ---------------------------------------------------------------->
<form id="s3" method="post" action="admin-page3" enctype="multipart/form-data" class="section0-1">
...
<!---------------------------------------------------------------- SECTION 4 ---------------------------------------------------------------->
<form id="s4" method="post" action="admin-page3" enctype="multipart/form-data" class="section0-1">
...
<div class="section2-2">
    ...
    <div class="section2-2">
      <div class="section3-1">
        ...
        <label for="file_logo4"><img src ="../ressources/images/<?php echo $section4->getId();?>.webp?v=<?php echo date('ymdhis')?>" class="log_admin"></label>
      </div>
      <div class="section3-1">
        <label>Titre</label>
