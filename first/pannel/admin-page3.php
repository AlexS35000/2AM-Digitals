...
$section1   = Contenu::selectOneById('3');
$section2   = Contenu::selectOneById('300');
$section3   = Contenu::selectOneById('301');
$section4   = Contenu::selectOneById('302');
// ------------------------------------------------------------------------ Import photos
...
if(isset($_POST['id'])){
    ...
    echo "<script type='text/javascript'>window.location='admin-page3';</script>";
}

include('../vue/admin3.php');
