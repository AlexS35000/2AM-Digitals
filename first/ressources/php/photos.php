...
if (empty($_FILES['image1']['name'])) {} else {
    ...
    $ext            = strtolower($ext0);
    $uploadfile     = '../ressources/catalogue/' . $id . '-1.webp';
...
if (empty($_FILES['image2']['name'])) {} else {
    ...
    $ext0           = pathinfo($logo, PATHINFO_EXTENSION);
    $ext            = strtolower($ext0);
    $uploadfile     = '../ressources/catalogue/' . $id . '-2.webp';
    $dimension      = getimagesize($fichier);
    $largeur        = $dimension[0];
    $hauteur        = $dimension[1];
    $hautmax        = 640;
...
if (empty($_FILES['image3']['name'])) {} else {
    ...
    $ext0           = pathinfo($logo, PATHINFO_EXTENSION);
    $ext            = strtolower($ext0);
    $uploadfile     = '../ressources/catalogue/' . $id . '-3.webp';
    $dimension      = getimagesize($fichier);
    $largeur        = $dimension[0];
    $hauteur        = $dimension[1];
    $hautmax        = 640;
...
if (empty($_FILES['image4']['name'])) {} else {
    ...
    $ext0           = pathinfo($logo, PATHINFO_EXTENSION);
    $ext            = strtolower($ext0);
    $uploadfile     = '../ressources/catalogue/' . $id . '-4.webp';
    $dimension      = getimagesize($fichier);
    $largeur        = $dimension[0];
    $hauteur        = $dimension[1];
    $hautmax        = 640;
...
if (empty($_FILES['image5']['name'])) {} else {
    ...
    $ext0           = pathinfo($logo, PATHINFO_EXTENSION);
    $ext            = strtolower($ext0);
    $uploadfile     = '../ressources/catalogue/' . $id . '-5.webp';
    $dimension      = getimagesize($fichier);
    $largeur        = $dimension[0];
    $hauteur        = $dimension[1];
    $hautmax        = 640;
