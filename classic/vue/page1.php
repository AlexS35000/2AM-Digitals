        ...
        <div id="s4" class="section2-1" style="<?php echo $f4;?>">
            ...
            <div class="section4">
                <form method="post" action="page2.php" enctype="multipart/form-data">
                    ...
                    <label style="<?php echo $s42; ?>">Votre adresse e-mail</label>
                    ...
                    <label style="<?php echo $s42; ?>">Votre message</label>
